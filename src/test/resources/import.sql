...
-- Create Accesses
INSERT INTO access (id, name, description) VALUES (1, 'PUBLIC','Visible to all users'), (2, 'GROUP', 'Visible to members of specified group'), (3, 'PRIVATE','Visible only to creator');

-- Create Persons
INSERT INTO person (id, email, first_name, last_name, middle_name, workspace) VALUES (1, 'isaac@example.com', 'Isaac', 'Newton', NULL, '~/ccd_workspace/'), (2, 'alan@example.com', 'Alan', 'Turing', NULL, '~/ccd_workspace/'), (3, 'bspears@localhost', 'Britney', 'Spears', NULL, '/home/bspears');

-- Create User Accounts
INSERT INTO user_account (id, public_key, private_key, active, created_date, last_login_date, password, username, person_id, account_id) VALUES (1, NULL, NULL, b'1', '2016-03-24 15:37:06', CURRENT_TIMESTAMP, '$2a$10$LTFYDfz3oBc96cKgaOkz2OIy8OYlT5o5TTYaJCRXr0s2.ahXAuAvK', 'isaac', 1, 'f0e4d573-e85a-4c52-8426-89fa55f36c7c'), (2, NULL, NULL, b'1', '2016-03-24 15:37:06', CURRENT_TIMESTAMP, '$2a$10$ad0/roYTf7qhQlAjXl5m5.duYGtMw4dHgN.bauA/mi5eZV67937WS', 'alan', 2, '2a7dc1f4-a95c-42e1-a694-792acdc2e2c5'), (3, NULL, NULL, b'1', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'hello', 'bspears', 3, '123456789');

-- Create User Role
INSERT INTO user_role (id, name, description) VALUES (1, 'USER', 'User role'), (2, 'ADMIN', 'Administrator');

INSERT INTO role_permission (id,name,description) VALUES (1,'read','Read permission.'), (2, 'write', 'Write permission.');

INSERT INTO user_role_role_permission_rel (user_role_id, role_permission_id) VALUES (1, 1), (2, 2);

-- Create User Role User Account relationships
INSERT INTO user_account_user_role_rel (user_account_id, user_role_id) VALUES (1, 1), (1, 2), (2, 1), (3, 1);

-- Create Groups
INSERT INTO groups (id, name, description) VALUES (1, 'Scientists', 'Group of famous scientists');

-- Create Group_Membership mappings
INSERT INTO group_membership (user_account_id, group_id) VALUES (1, 1);     -- User Isaac is a member

-- Create Group_Moderation mappings
INSERT INTO group_moderation (user_account_id, group_id) VALUES (1, 1);     -- User Isaac is a moderator

-- Create Group_Requests mappings
INSERT INTO group_requests (user_account_id, group_id) VALUES (2, 1);       -- User Alan is requesting Group access
...
-- Create Attributes
INSERT INTO attribute (id, level, name, requirement_level, vocabulary_id) VALUES (1, NULL, 'text', NULL, 1);
