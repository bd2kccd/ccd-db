...
insert into user_account(id,account,active,disabled,password,registration_date,registration_location,username,person_id,user_login_id,user_login_attempt_id,user_role_id) values (1,'56755429-351c-4fc5-888f-94679818d061',true,false,'$shiro1$SHA-256$500000$J/+mLlMDC7XRWVc8TfSl5w==$CrpVSMPiw8AGT7nGfbs3ajWCUZ8tjX1vmuOxXPGy6cM=',CURRENT_TIMESTAMP,2130706433,'bspears',1,1,1,1)
