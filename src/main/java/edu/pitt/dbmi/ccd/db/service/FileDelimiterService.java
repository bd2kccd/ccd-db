...
public class FileDelimiterService {
    ...
    public FileDelimiterService(FileDelimiterRepository fileDelimiterRepository) {
        ...
        if (fileDelimiters.isEmpty()) {
            for (FileDelimiterEnum delim : FileDelimiterEnum.values()) {
    ...
    public FileDelimiter findByEnum(FileDelimiterEnum fileDelimiterEnum) {
        return fileDelimiterRepository.findByName(fileDelimiterEnum.name());
    }
